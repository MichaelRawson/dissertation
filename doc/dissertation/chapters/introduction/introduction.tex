...
For extension work, I also implemented unit and pair terms and associated types, and showed that the \(\beta\)-reduction relation is confluent using a proof technique due to Tait, Martin-L\"of, and Takahashi.
