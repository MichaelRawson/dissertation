...
data Type = TUnit | TVar Arith.Nat | TArr Type Type | TPair Type Type deriving (Eq, Prelude.Show);

data Ptrm a = PUnit | PVar a | PApp (Ptrm a) (Ptrm a) | PFn a Type (Ptrm a)
  | PPair (Ptrm a) (Ptrm a) | PFst (Ptrm a) | PSnd (Ptrm a) deriving (Prelude.Show);
